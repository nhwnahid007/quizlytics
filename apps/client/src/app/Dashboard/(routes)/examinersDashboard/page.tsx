...
import { deleteCustomQuiz } from "@/services/quiz.service";
        ...
        deleteCustomQuiz(id)
          ...
          .catch(() => {
            Swal.fire({
              title: "Error",
              toast: true,
              text: "Quiz set could not be deleted.",
              icon: "error",
            });
          });
      }
                ...
                <TableRow key={item.id}>
                  ...
                  <TableCell className="font-medium flex  items-center ">
                    ...
                    <Tooltip>
                      <TooltipTrigger>
                        <FaRegCopy
                          onClick={() => handleCopy(item.quizStartKey ?? undefined)}
                  ...
                  <TableCell className="text-center">{item.quizArr?.length ?? 0}</TableCell>
                  <TableCell className="text-right">
                    <Button
                      variant="buttonOutline"
                      size="sm"
                      onClick={() => handleDelete(item.quizStartKey ?? undefined)}
                    >
