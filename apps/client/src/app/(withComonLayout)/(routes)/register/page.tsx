...
const Register = () => {
  ...
  const handleRegister = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const profileImgFill = elements.my_profile.files?.[0];
    ...
    try {
      ...
      const imgRes = await axios.post<ImgBBResponse>(img_hosting_api, formData);
  ...
  return (
    <Suspense fallback={<LoadingSpinner></LoadingSpinner>}>
      <div className="flex pt-10 min-h-screen justify-center gap-20 items-center h-screen bg-white">
        ...
        <div className="w-full max-w-md p-4">
          ...
          <form onSubmit={handleRegister}>
            <div className="space-y-3 lg:space-y-6">
              ...
              {validState === "Please fill out all fields!" && (
