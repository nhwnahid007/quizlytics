...
const Exam = () => {
    ...
    }, [userExamData, name, email, image, profile, examId, today, isDataSent, showResult]); // if add currentMCQ dependency, Data save to database twice that is very unpredictable, this is why I ignore this dependency 
