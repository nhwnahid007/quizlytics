  ...
  return (
    <div className="bg-gray-50 text-black">
      <div className="w-full lg:w-[70%] mx-auto py-8 text-center">
        ...
        <h2 className="text-4xl font-bold text-primary-color mb-4">Explore Key Features</h2>

        {/* Feature 1 - AI Generated Quizzes */}
        <div className="flex flex-col md:flex-row items-center justify-between bg-gray-50 py-10 px-6 md:px-16 lg:px-20">
          {/* Text Section */}
